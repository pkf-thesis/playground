...
def split_song(song, num_segments, dim):
    ...
    while 1:
        ...
        for iter2 in range(0, int(subset_size * num_segments / batch_size)):
            ...
            for batch_index in range(0, batch_size):
                x_train_sub_batch[batch_index] = x_train_sub[int(batch_index * subset_size * num_segments / batch_size) + j, :]
                y_train_sub_batch[batch_index] = y_train_sub[int(batch_index * subset_size * num_segments / batch_size) + j, :]
