...
class ResNet(BaseModel):
    ...
    def build_model(self):
        ...
        bn1 = BatchNormalization(name="bn0")(conv1)
        activ1 = Activation(activ, name="activ0")(bn1)

        conv2 = Conv1D(128, 3, strides=3, padding='valid', kernel_initializer=init)(activ1)
        bn2 = BatchNormalization(name="bn0")(conv2)
        activ2 = Activation(activ, name="activ0")(bn2)

        res1 = self._shortcut(activ0, activ2)

        # Second
        conv3 = Conv1D(256, 3, strides=3, padding='valid', kernel_initializer=init)(res1)
        bn3 = BatchNormalization(name="bn0")(conv3)
        activ3 = Activation(activ, name="activ0")(bn3)

        conv4 = Conv1D(256, 3, strides=3, padding='valid', kernel_initializer=init)(activ3)
        bn4 = BatchNormalization(name="bn0")(conv4)
        activ4 = Activation(activ, name="activ0")(bn4)

        res2 = self._shortcut(res1, activ4)

        # Third
        conv5 = Conv1D(256, 3, strides=3, padding='valid', kernel_initializer=init)(res2)
        bn5 = BatchNormalization(name="bn0")(conv5)
        activ5 = Activation(activ, name="activ0")(bn5)

        conv6 = Conv1D(256, 3, strides=3, padding='valid', kernel_initializer=init)(activ5)
        bn6 = BatchNormalization(name="bn0")(conv6)
        activ6 = Activation(activ, name="activ0")(bn6)

        res3 = self._shortcut(res2, activ6)

        # Fourth
        conv7 = Conv1D(512, 3, strides=3, padding='valid', kernel_initializer=init)(activ6)
        bn7 = BatchNormalization(name="bn0")(conv7)
        activ7 = Activation(activ, name="activ0")(bn7)

        conv8 = Conv1D(512, 3, strides=3, padding='valid', kernel_initializer=init)(activ7)
        bn8 = BatchNormalization(name="bn0")(conv8)
        activ8 = Activation(activ, name="activ0")(bn8)
